    ...
    const fetchProperties = async () => {
      try {
        const response = await fetch(
          "https://ernestgaisie--house-prediction-fastapi-app-fastapi-app.modal.run/listings-below-prediction",
          {
            method: "POST",
    ...
    <div className="space-y-8">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {properties.map((property) => (
          ...
          >
            <CardHeader>
              <Image className="rounded-[10px] mb-[5px]"
                src={
            ...
            <CardContent className="flex-grow">
              <p className="font-bold text-xl text-primary mb-4 text-[#1c7e97]">
